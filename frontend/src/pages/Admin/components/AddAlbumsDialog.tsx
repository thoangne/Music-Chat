...
const AddAlbumDialog = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await AxiosInstance.post("/admin/ablums", formData, {
        headers: {
    ...
    <Dialog open={albumDialogOpen} onOpenChange={setAlbumDialogOpen}>
      ...
      <DialogContent className="bg-zinc-900 border border-zinc-700 text-white">
        ...
        <div className="space-y-4 py-4">
          ...
          />
          <div
            className="flex items-center justify-center p-6 border-2 border-dashed border-zinc-700 rounded-lg cursor-pointer hover:bg-zinc-800 transition"
          ...
          >
            <div className="text-center">
              ...
              <Button
                variant="outline"
                size="sm"
                className="text-xs border-violet-500 text-violet-400 hover:bg-violet-500 hover:text-white"
              >
                Choose File
              </Button>
            </div>
