...
const AlbumPage = () => {
  ...
  const { fetchAlbumsId, currentAblum, isLoading } = useMusicStore();
          ...
          >
            <div className="relative z-10">
              <div className="flex p-6 gap-6 pb-8">
                <img
                  src={currentAblum?.imageUrl || "/image.png"}
                  alt={currentAblum?.title}
                ...
                <div className="flex flex-col justify-end">
                  ...
                  <div className="flex gap-2 text-sm text-zinc-100 items-center">
                    ...
                    <span>| {currentAblum?.songs.length} songs</span>
                    <span>| {currentAblum?.releaseYear || "2025"}</span>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-black/20 backdrop-blur-sm rounded-lg overflow-hidden">
              ...
              <div className="px-4">
                <div className="divide-y divide-white/5">
                  {currentAblum?.songs.map((song, index) => (
                    <div
                      key={song._id}
